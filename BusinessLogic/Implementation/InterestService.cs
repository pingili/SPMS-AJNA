    ...
    public class InterestService 
    {
        ...
        public InterestMasterDto GetByID(int interestID)
        {
            ...
            var results = new MFISDBContext()
                .MultipleResults(MFIEntityFrameWork.ProcNames.uspInterestByID, prmInterestId)
        ...
        public InterestViewDto GetLoanViewByID(int interestId)
        {
            ...
            var results = new MFISDBContext()
                .MultipleResults(MFIEntityFrameWork.ProcNames.uspLoanInterestGetViewByID, prminterestId)
        ...
        public InterestViewDto GetViewByID(int interestId)
        {
            ...
            var results = new MFISDBContext()
                .MultipleResults(MFIEntityFrameWork.ProcNames.uspDepositInterestGetViewByID, prminterestId)
                .With<InterestViewDto>()
                .With<InterestRatesDto>()
                .Execute();

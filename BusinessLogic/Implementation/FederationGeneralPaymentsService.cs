...
{
    public class FederationGeneralPaymentsService 
    {
        ...
        public GeneralPaymentsDto GetByID(long AccountMasterId)
        {
            ...
            var results = new MFISDBContext()
                .MultipleResults(ProcNames.uspGeneralPaymentsGetById, prmAccountMasterId)
        ...
        public GeneralPaymentsDto GetByViewID(long AccountMasterId)
        {
            ...
            var results = new MFISDBContext()
                .MultipleResults(ProcNames.uspGeneralPaymentsViewGetById, prmAccountMasterId)
                .With<GeneralPaymentsDto>()
                .With<AddAmountDto>()
                .Execute();

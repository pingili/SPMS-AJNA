...
namespace MFIS.Web.Areas.Group.Controllers.TransactionControllers
{
    public class ContraEntryController : BaseController
    {
        ...
        private ContraEntryWithDrawlDto ReadFormDataWithDrawl(FormCollection form)
        {
            ...
            string tranDate = Request.Form["TransactionDate"];
            DateTime dtTranDate = tranDate.ConvertToDateTime();
            contraEntryWithDrawlDto.TransactionDate = dtTranDate;
        ...
        {
            var lstContraEntryCashWithDrawlLookup = _ContraEntryService.GroupContraEntryWithDrawlLookup(GroupInfo.GroupID);
        ...
        {
            var lstContraEntryCashDepositedLookup = _ContraEntryService.GroupContraEntryDepositedLookup(GroupInfo.GroupID);

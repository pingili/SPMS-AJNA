...
{
    public class ContraEntryWithDrawlDto
    {
      ...
      //  public long AccountTranID { get; set; }
        ...
        public List<ContraEntryWithDrawlTransactionsDto> contraEntryWithDrawlTransactions { get; set; }
    }
    public class ContraEntryWithDrawlTransactionsDto
    {
        public int AHID { get; set; }
        [XmlIgnore]
    ...
    public class ContraEntryWithDrawlLookupDto
    {
        public long AccountMasterID { get; set; }
        public string VoucherNumber { get; set; }
        public string AHName { get; set; }
